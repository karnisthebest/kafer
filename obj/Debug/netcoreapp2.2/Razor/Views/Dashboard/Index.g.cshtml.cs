#pragma checksum "c:\Users\Pete pc\Desktop\kafer - Copy (2)\Views\Dashboard\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8f648e18c5f77e1fceba9f6ae79fd70a1d937a1f"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8f648e18c5f77e1fceba9f6ae79fd70a1d937a1f", @"/Views/Dashboard/Index.cshtml")]
        ...
        <div class=""col-md-4"">
            <div class=""form-group"">
                ...
                <div class=""input-daterange input-group"" data-date-format=""dd/mm/yyyy"" data-week-start=""1"" data-autoclose=""true"" data-today-highlight=""true"">
                    ...
                    <inpu");
            WriteLiteral(@"t type=""text"" class=""form-control"" id=""date_loss_2"" name=""date_loss_2"" placeholder=""To"" data-week-start=""1"" data-autoclose=""true"" data-today-highlight=""true"">
                </div>
            </div>
        </div>
        <div class=""col-md-2"">
...
");
    ...
    <script>
        ...
        function shoppingMall_dat");
                WriteLiteral(@"a_arrived(data){
        ...
        function loss_done(data){
            ...
            $.each(filtered, function (key, item) {
                ...
                var total = item.allItems.reduce(function(acc, curr){
                    ...
                    return {productLoss: acc.productLoss + curr.p");
                WriteLiteral(@"roductLoss}
                });
                ...
                accordianTable.append(
                    '<div class=""block block-rounded mb-1""><div  class=""block-header block-header-default"" role=""tab"" id=""accordion2_h1""><a class=""font-w600"" data-toggle=""collapse"" data-parent=""#accordion2"" href=""#' +  'key' + key  + '""' + 'aria-expanded=""true"" aria-controls=""accordion2_q1"">'
                        ...
                        '</a><a class=""font-w600"" data-toggle=""collapse"" data-parent=""#accordion2"" href=""#' +  'key' + key  + '""' + 'aria-expanded=""true"" aria-controls=""accordion2_q1"">'
                            ...
                            '<div id=""' + 'key' + key  + '"" class=""collapse"" role=""tabpanel"" aria-labelledby=""accordion2_h1""><div class=""block-content""><div class=""table-responsive""><table id=""dataTable"" class=""table table-bordered table-striped table-vcenter""><the");
                WriteLiteral(@"ad><tr>'
        ...
        function confirm_done(data){
            ...
            if(!helper[key]) {
                ...
                helper[key].productQty += cu");
                WriteLiteral(@"rr.productQty;
            }
